...
__C.YOLO.CLASSES              = "./data/classes/trafficlights.names"
...
__C.TRAIN.ANNOT_PATH          = "./data/dataset/trafficlights_short.txt"
...
__C.TEST.ANNOT_PATH           = "./data/dataset/trafficlights_short.txt"
